...
import { ArrowLeft, Download, CheckCircle, RefreshCw, Loader2, Play } from 'lucide-react'
...
export default function AdminTopicContentPage() {
    ...
    const handleGenerateContent = async (feedback?: string) => {
        setGenerating(true)
        try {
            await fetch(`http://localhost:8000/topics/${topicId}/generate-content`, {
                method: 'POST',
                headers: {
