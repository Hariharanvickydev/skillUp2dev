...
import { ArrowLeft, CheckCircle, Filter, Search, BookOpen, AlertCircle } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500">Review pending course content from your department.</p>
                    </div>
                </div>
                                    ...
                                    {filteredApprovals.map((item: any) => (
                                        <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-slate-500">Submitted {new Date(item.created_at).toLocaleDateString()}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <Button
                                                    size="sm"
                                                    onClick={() => router.push(`/org/courses/${item.course_id}/topic/${item.id}`)}
