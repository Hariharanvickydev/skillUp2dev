        ...
        <div className="max-w-7xl mx-auto p-8 lg:p-12 space-y-10 pb-20">
                                                        ...
                                                        <div key={topic.id} className="p-4 pl-16 pr-6 flex items-center justify-between hover:bg-indigo-50/30 transition-colors group/topic">
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                >
                                                                    ...
                                                                    {topic.status === 'APPROVED' ? "Review Content" : "Manage Content"}
                                                                </Button>
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        <Input placeholder="Topic Title" value={editingTopic?.title || ""} onChange={(e) => setEditingTopic({ ...editingTopic, title: e.target.value })} />
                        <Textarea placeholder="Description" value={editingTopic?.description || ""} onChange={(e) => setEditingTopic({ ...editingTopic, description: e.target.value })} />
                    </div>
                    <DialogFooter>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                <DialogContent>
                    <DialogHeader><DialogTitle>{parentTopicForSubtopic ? `Add Topic to ${parentTopicForSubtopic.title}` : "Add New Module"}</DialogTitle></DialogHeader>
                    <div className="space-y-4 py-4">
                        <Input placeholder="Title" value={newTopicData.title} onChange={(e) => setNewTopicData({ ...newTopicData, title: e.target.value })} />
                        <Textarea placeholder="Description" value={newTopicData.description} onChange={(e) => setNewTopicData({ ...newTopicData, description: e.target.value })} />
                    </div>
                    <DialogFooter>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will delete <strong>{topicToDelete?.title}</strong> and all its content. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                        <AlertDialogAction className="bg-red-600 hover:bg-red-700" onClick={handleDeleteTopic}>Delete</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
        </div>
